...
# write_csv(res_full, "current_version/models/RFE_cor_filter_opt_cv.csv")

res_full <- read_csv("current_version/models/RFE_cor_filter_opt_cv.csv")
...
X_opt <- readRDS("current_version/models/RFE_cor_filter_best.rda")
...
# saveRDS(X, "current_version/models/RFE_cor_filter_best.rda")
X <- readRDS("current_version/models/RFE_cor_filter_best.rda")
