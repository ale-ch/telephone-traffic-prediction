...
# saveRDS(X_sub, "current_version/models/RFE_subsets.rda")
# write_csv(res_full, "current_version/models/RFE_results.csv")
res_full <- read_csv("current_version/models/RFE_results.csv")
